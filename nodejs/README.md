...
<div class="alert-primary">
<p>
Note: Users of macOS 10.13 (High Sierra) and later should read <a href="https://github.com/Blizzard/node-rdkafka/blob/master/README.md#mac-os-high-sierra--mojave">node-rdkafka’s additional configuration instructions</a> related to OpenSSL before running `npm install`.
</p>
</div>
