...
- If you are interested in the Kafka Streams client library, learn
  more about it in the [documentation](https://docs.confluent.io/platform/current/streams/index.html)
