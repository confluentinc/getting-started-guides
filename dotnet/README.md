...
- To learn how to implement a cross-platform Apache Kafka® producer and consumer with C# and .NET, read the [blog](https://www.confluent.io/blog/build-cross-platform-kafka-applications-using-c-and-dotnet-5/).
